...
## Description
This project implement a **negative edge triggered JK Flip Flop** using Verilog.

A JK Flip Flop captures the input value **D** at the rising edge of the clock and holds the value at the output **Q** untill the next clock edge.
